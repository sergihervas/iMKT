...
#' # mygenes <- c("")
#' ## Perform analyses
#' # PopHumanAnalysis(genes=mygenes , pops=c(""), recomb=F, test="iMK", xlow=0, xhigh=0.9)
#' # PopHumanAnalysis(genes=mygenes , pops=c(""), recomb=T, bins=3, test="DGRP")
#' 
#' @import utils
#' @import stats
#'
...
PopHumanAnalysis <- function(genes=c("gene1","gene2","..."), pops=c("pop1","pop2","..."), recomb=TRUE/FALSE, bins=0, test=c("standard","DGRP","FWW","asymptotic","iMK"), xlow=0, xhigh=1) { 
