...
divergenceParameters <- function(daf="Data frame containing the DAF, Pi and P0", divergence="Data frame that contains sites analyzed and divergencen 0fold and 4fold") {
