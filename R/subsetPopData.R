...
#' # subsetPopData("PopFly", mygenes , c("RAL","ZI"), recomb=F)
#'
#' @import utils
#' @import stats
#'
...
## a <- subsetPopData("PopFly", gen , c("RAL","ZI"), recomb=F, bins=3, test="DGRP")
## b <- subsetPopData("PopFly", gen , c("RAL","ZI"), recomb=T, bins=3)
## subsetPopData("PopFly", gen , c("RAL","ZI"), recomb=T, bins=3, test="FWW")
...
## subsetPopData("PopFly", gen , c("RAL","ZI"), recomb=F, test="asymptotic", xlow=0, xhigh=0.9)

subsetPopData <- function(data=c("PopFly","PopHuman"), genes=c("gene1","gene2","..."), pops=c("pop1","pop2","..."), recomb=TRUE/FALSE, bins=0, test=c("standard","DGRP","FWW","asymptotic","iMK"), xlow=0, xhigh=1) { 
