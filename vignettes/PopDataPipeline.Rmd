...
In this second example, genes from RAL population are groupped in 2 recombination bins, using recombination values from Comeron et al. 2012 Plos Genetics. The test used is iMKT, with xlow and xhigh values set to 0 and 0.9, respectively.
